function move(n,t,i){$.post("/Tasks/"+t+"/"+n).done(n=>{let t=$("#"+n.id);i.append(t)})}function start(n){move(n,"Start",$("#InProgressList"))}function drop(n){move(n,"Drop",$("#ToDoList"))}function finish(n){move(n,"Finish",$("#DoneList"))}function retake(n){move(n,"Retake",$("#InProgressList"))}
